...
| [PicoTTS `bf1a8df`](https://github.com/DiUS/esp-picotts/commit/bf1a8df9d2be1e088a03a775d439ac66e18438dc) | Offline speech synthesis with runtime-loaded voices | Apache-2.0; DiUS Computing, SVOX AG, and contributors. See the retained [`NOTICE`](components/picotts.NOTICE). |
