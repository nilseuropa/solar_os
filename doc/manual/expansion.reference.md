...
| `sim7670` | SIM7670 LTE modem and GNSS receiver | `uart=<bus>` | Registers modem profile, AT/status, GNSS, and a generic IPv4 PPP service bound to the exclusively claimed UART. PPP-enabled targets reserve the UART for network frames until disconnected. |
