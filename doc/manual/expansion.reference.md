...
| `sim7670` | SIM7670 LTE modem and GNSS receiver | `uart=<bus>` | Registers modem profile, AT/status, IPv4 PPP, and GNSS services on an exclusively claimed UART. PPP-enabled targets reserve the UART for network frames until disconnected. |
