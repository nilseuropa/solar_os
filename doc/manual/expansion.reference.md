...
| `sim7670` | SIM7670 LTE modem and GNSS receiver | `uart=<bus>` | Registers modem AT/status commands and a GNSS provider on an exclusively claimed UART. PPP data is not yet provided. |
