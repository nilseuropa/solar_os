...
static void audio_status_from_driver(solar_os_board_audio_status_t *out,
                                     const audio_aw88298_board_status_t *in)
{
...
{
    return audio_aw88298_board_init();
}
...
void solar_os_board_audio_get_status(solar_os_board_audio_status_t *status)
{
    ...
    audio_aw88298_board_status_t driver_status;
    audio_aw88298_board_get_status(&driver_status);
