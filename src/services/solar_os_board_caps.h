...
typedef enum {
    ...
    SOLAR_OS_BOARD_CAP_EXPANSION_GPIO = 1U << 25,
    SOLAR_OS_BOARD_CAP_EXPANSION_I2C = 1U << 26,
    SOLAR_OS_BOARD_CAP_EXPANSION_SPI = 1U << 27,
    SOLAR_OS_BOARD_CAP_EXPANSION_UART = 1U << 28,
    SOLAR_OS_BOARD_CAP_EXPANSION_ADC = 1U << 29,
    SOLAR_OS_BOARD_CAP_EXPANSION_PWM = 1U << 30,
